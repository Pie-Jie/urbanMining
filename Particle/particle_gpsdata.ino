...
void setup()
{
  ...
  // Serial monitor check voor library en gps data
  Serial.print(F("Testing TinyGPS++ library v. ")); Serial.println(TinyGPSPlus::libraryVersion());
  Serial.println(F("by Mikal Hart"));
  Serial.println();
  Serial.println(F("Sats HDOP Latitude   Longitude   Fix  Date       Time     Date Alt    Course Speed Card  Course Card  Chars Sentences Checksum"));
...
void loop()
{
  //------------------ Gps test + serial printen naar console --------------------------------------------------------------------------------------
...
//----------------------------------------Zet gps data om naar string en publish string-------------------------------------------------------------------------------------------------
...
//----------------------------- gps.encode nodig om data te verkrijgen van gps --------------------------------------------------------------------------
